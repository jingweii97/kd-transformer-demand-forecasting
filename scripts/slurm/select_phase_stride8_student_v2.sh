#!/bin/bash -l
# Usage: sbatch scripts/slurm/select_phase_stride8_student_v2.sh <stride8_wis|stride8_wikd> <no_kd|kd>
#SBATCH --partition=gpu-a100
#SBATCH --job-name=select_phase_stride8_v2
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH --mem=32G
#SBATCH --qos=long
#SBATCH --output=logs/slurm/select_phase_stride8_v2_%j.out
#SBATCH --error=logs/slurm/select_phase_stride8_v2_%j.err
set -euo pipefail
